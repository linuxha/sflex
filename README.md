...
I stole this from DeRamp's (FLEX on MP-S (serial FLEX))[https://deramp.com/downloads/swtpc/software/FLEX/FLEX%20on%20MP-S%20(serial%20FLEX)/] page (and a few other). I've collected these for future use in a project where there is a (Linux Flex Server)[https://github.com/linuxha/fnetsrv] and a (Pico Flex Terminal Server)[https://github.com/linuxha/pico-flex-ts]. At the moment I need to create a proper requirements document so that the 6809 & 6800 Flex version are consistent.
